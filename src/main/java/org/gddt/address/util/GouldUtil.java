...
public class GouldUtil {
    ...
    //在高德申请的应用Key
    private static final String GOULD_KEY="3c52c5f25c22fd817a01668e1bc6fe53";
...
//		System.out.println("经纬度：" + DZ);
    ...
    public String getAMapByLngAndLat(String getLng, String getLat) throws Exception {
        String url;
        try {
//            url2 = "https://restapi.amap.com/v3/geocode/regeo?output=xml&location=" + getLng + "," + getLat
//                    + "&key="+GOULD_KEY+"&radius=1000&extensions=all";
